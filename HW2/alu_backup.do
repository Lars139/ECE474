...
#This is 0000_0000 against 0000_0000
force in_a  x"00"
force in_b  x"00"
...
#This is 1010_1010 against 0000_0000
force in_a  x"AA"
force in_b  x"00"
...
#This is 1010_1010 against 1010_1010
force in_a  x"AA" 
force in_b  x"AA" 
...
#This is testing 0000_0000 against 1010_1010
force in_a  x"00" 
force in_b  x"AA" 
...
#This is 0101_0101 against 0000_0000
force in_a  x"55"
force in_b  x"00"
...
#This is 0101_0101 against 0101_0101
force in_a  x"55" 
force in_b  x"55" 
...
#This is testing 0000_0000 against 0101_0101
force in_a  x"00" 
force in_b  x"55" 
...
#This is testing 0000_0000 against 1111_1111 
force in_a  x"00" 
force in_b  x"FF" 
